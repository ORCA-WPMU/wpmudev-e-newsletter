...
Contributors: WPMU DEV, Maniu, Cole, Andrey, AndiBecker
Tags: newsletter
...
The ultimate WordPress email newsletter plugin for WordPress
...
Members who use older PHP versions are asked to download the last version before that one which is Version 2.7.4.3.
